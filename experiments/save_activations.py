...
def main():
    ...
    layers = [n for n,m in model.named_modules() if 
              isinstance(m,getattr(sys.modules[__name__], args.layer_type))]
    ...
    masked_model.save_activations(image_list,transforms,os.path.join(args.data_path,'activations',model_name))
